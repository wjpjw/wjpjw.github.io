...
(function() {
    ...
    var CanvasInput = window.CanvasInput = function(o) {
        ...
        if (self._canvas) {
            self._canvas.addEventListener('mousemove', mouseMoveH, false);
            self._canvas.addEventListener('mousedown', mouseDownH, false);
            self._canvas.addEventListener('mouseup', mouseUpH, false);
        }
    ...
    CanvasInput.prototype = {
        ...
        destroy: function() {
            var self = this;
            // self._canvas.removeEventListener('mousemove', mouseMoveH, false);
            // self._canvas.removeEventListener('mousedown', mouseDownH, false);
            //self._canvas.removeEventListener('mouseup', mouseUpH, false);
            ...
            window.removeEventListener('mouseup', autoBlur, true);
            window.removeEventListener('touchend', autoBlur, true);
